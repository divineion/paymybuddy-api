...
public class TransferController {
	...
	public ResponseEntity<TransferDto> createTransfer(@RequestBody TransferRequestDto transferReqDto) throws UserNotFoundException, InsufficientBalanceException {
